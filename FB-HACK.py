...
def banner():
    ...
    print GG+"  √=============================================√"
    print WW+"  |            MOD BY: Meer Sultan              |"
    print GL+"  |            ALWAYS: PAKISTAN ZINDABAD        |"
    print WW+"  |            TEAM : pak Cyber ErRoR SyStEm    |"
    print Y+"  |             FACEBOOK: meersultan143          |"
    print GL+"  |---------------------------------------------|"
